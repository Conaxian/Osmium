...
export const permCategories = {
  ...
  "text-channels": Object.values(TextChannelPerm),
  "voice-channels": Object.values(VoiceChannelPerm),
  special: Object.values(SpecialPerm),
};

export const allPerms: Perm[] = [
  ...permCategories.administration,
  ...permCategories.moderation,
  ...permCategories["text-channels"],
  ...permCategories["voice-channels"],
  ...permCategories["special"],
];
